...
if (!Object.getPrototypeOf || !Object.defineProperty || !window.history ||
	...
	document.write('<link href="${ stRoot }users-admin.css" rel="stylesheet" />');
	document.write('<scr' + 'ipt src="${ stRoot }users-admin.legacy.js"></sc' + 'ript>');
	document.write('<scr' + 'ipt data-spa src="${ stRoot }users-admin.js"></sc' + 'ript>');
}
	</script>
