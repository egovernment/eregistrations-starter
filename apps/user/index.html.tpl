...
if (!Object.getPrototypeOf || !Object.defineProperty || !window.history ||
	...
	document.write('<link href="${ stRoot }user.css" rel="stylesheet" />');
	document.write('<scr' + 'ipt src="${ stRoot }user.legacy.js"></sc' + 'ript>');
	document.write('<scr' + 'ipt data-spa src="${ stRoot }user.js"></sc' + 'ript>');
}
	</script>
