...
function setupWindow(window, args) {
  ...
  window.EventSource = function (url) {
    url = resourceLoader.resolveResourceUrl(document, url);
    var eventSource = new EventSource(url,{ headers: { Cookie: window.cookies } });
...
function getHTMLFromResponseBody(buffer, contentType) {
  ...
  if (mimeType) {
    ...
    try {
      for (var _iterator = _getIterator(typeOptions), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  if (mimeType === 'multipart/form-data') {
    ...
    try {
      for (var _iterator3 = _getIterator(params), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        ...
        try {
          for (var _iterator4 = _getIterator(values), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
