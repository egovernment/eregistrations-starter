...
module.exports = exports = function (routes, user) {
	...
	interceptSubmit(document, location, function (form, submitControl) {
		...
		db._postponed_ += 1;
		try {
			var businessProcess = user && user.currentBusinessProcess;
			result = router.routeEvent(context = {
				...
				dbRelease: dbRelease,
				referer: parse(location.href, true)
			}, action.pathname, getFormData.call(form, { submitControl: submitControl }));
		} catch (e) {
