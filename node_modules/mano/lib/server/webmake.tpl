...
(function () {
	...
	(function () {
		...
		hr, i, iframe, img, input, ins, kbd, keygen, label, legend, li, link, main, map,
		...
		text, element, insert, normalize, _if, and, browser, eq, eqSloppy, eqSome, field, gt,
		gtOrEq, html, legacy, list, lt, ltOrEq, md, mdi, mmap, modal, not, or, postButton,
		...
		domjs.refreshViewNs = function () {
			...
			kbd = ns.kbd; keygen = ns.keygen; label = ns.label; legend = ns.legend; li = ns.li;
			...
			and = ns.and; browser = ns.browser; eq = ns.eq; eqSloppy = ns.eqSloppy; eqSome = ns.eqSome;
			field = ns.field; gt = ns.gt; gtOrEq = ns.gtOrEq; html = ns.html; legacy = ns.legacy;
			list = ns.list; lt = ns.lt; ltOrEq = ns.ltOrEq; md = ns.md; mdi = ns.mdi; mmap = ns.mmap;
			modal = ns.modal; not = ns.not; or = ns.or; postButton = ns.postButton; resolve = ns.resolve;
