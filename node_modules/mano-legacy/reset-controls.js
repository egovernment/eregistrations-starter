...
var dispatch = require('./dispatch-event')
  ...
  , resetInput, resetValue, resetContent, resetSelect, resetOption;
...
resetContent = function (el) {
	var nu = el.firstChild ? el.firstChild.data : '';
	if (el.value === nu) return;
	el.value = nu;
	dispatch(el, 'change');
};
...
module.exports = function (el) {
	...
	default:
		...
		forEach.call(el.getElementsByTagName('textarea'), resetContent);
	}
};
